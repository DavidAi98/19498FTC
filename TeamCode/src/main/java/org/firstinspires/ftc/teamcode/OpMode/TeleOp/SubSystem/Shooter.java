...
public class Shooter {
    ...
    public Shooter(HardwareMap hwMap) {
        ...
        turret1.setPosition(Constant.TURRET_MIN);
        turret2.setPosition(Constant.TURRET_MIN);
...
//            }
    ...
    public boolean isReady() {
        return calculatedTargetVelocity > 0 && Math.abs(leftShooter.getVelocity() - calculatedTargetVelocity) <= 80;
    }
}