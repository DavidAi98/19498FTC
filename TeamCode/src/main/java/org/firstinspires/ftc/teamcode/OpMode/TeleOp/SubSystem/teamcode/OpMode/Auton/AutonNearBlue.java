package org.firstinspires.ftc.teamcode.OpMode.TeleOp.SubSystem.teamcode.OpMode.Auton;//package org.firstinspires.ftc.teamcode.OpMode.Auton;
//
...
//    public static Pose initPos = new Pose(144-110.586, 136.840, Math.toRadians(180));
//    public static Pose shootingPos = new Pose(144-86.630, 83.536, Math.toRadians(180));
//    public static Pose redGate = new Pose(144-127.779, 70.099, Math.toRadians(180));
//    public static Pose pickup1Pos = new Pose(144-134.851, 35.006, Math.toRadians(180));
//    public static Pose pickup2Pos = new Pose(144-133.210, 58.890, Math.toRadians(180));
//    public static Pose pickup3Pos = new Pose(144-128.630, 83.309, Math.toRadians(180));
//    public static Pose endPos1 = new Pose(144-94.436, 72.293, Math.toRadians(180));
//
//
...
//                .addPath(new BezierCurve(
//                        shootingPos,
//                        new Pose(144-99.011, 27.583),
//                        new Pose(144-97.387, 35.157), // from (95.271,35.403)
//                        pickup1Pos))
...
//                .addPath(new BezierCurve(
//                        pickup1Pos,
//                        new Pose(144-108.552, 51.633), // from (80.155,42.166)
//                        shootingPos))
...
//                .addPath(new BezierCurve(
//                        shootingPos,
//                        new Pose(144-94.500, 62.064),
//                        new Pose(144-99.097, 57.113),  // from (90.298,59.470)
//                        pickup2Pos))
...
//
//        double calculatedTurretPos = -0.075 * turretRange + Constant.TURRET_RIGHT_MAX; // maybe add limelight
