...
//    public static Pose initPos = new Pose(80.028, 6.807, Math.toRadians(0));
//    public static Pose shootingPos = new Pose(86.917, 17.702, Math.toRadians(0));
//    public static Pose redGate = new Pose(131.475+6, 66.7, Math.toRadians(0));
//    public static Pose pickup1Pos = new Pose(132.7, 33, Math.toRadians(0));
//    public static Pose pickup2Pos = new Pose(132.7, 56, Math.toRadians(0));
//    public static Pose pickup3Pos = new Pose(125, 79,Math.toRadians(0));
...
//                .addPath(new BezierCurve(
//                        shootingPos,
//                        new Pose(91.719, 34.6),
//
//                        new Pose(91.198, 30.6),
//
//                        pickup1Pos))
...
//
//        double calculatedTurretPos = 0.57 * turretRange + Constant.TURRET_LEFT_MAX; // maybe add limelight
