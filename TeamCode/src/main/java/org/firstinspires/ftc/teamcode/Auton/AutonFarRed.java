...
public class AutonFarRed extends OpMode {
    ...
    private PathChain gateToPickup1, firstPickup1, firstPickup2, secondPickup1, secondPickup2, firstPickupShot, randomPickup, openBlueGate1, openBlueGate2, firstPickupBreak1, firstPickupBreak2, endPath, secondPickupBreak1, secondPickupBreak2, pickup2ToGate;
...
//                .setReversed()
        ...
        endPath = follower.pathBuilder()
                .addPath(new BezierCurve(
                        shootingPos,
                        new Pose(80.354, 70.011), // from 63.646 -> 80.354
                        endPos1
                ))
                .setTangentHeadingInterpolation()
                .build();
