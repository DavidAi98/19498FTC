...
//    public static Pose initPos = new Pose(31.210, 135.293, Math.toRadians(270));
//    public static Pose shootingPos = new Pose(51.2, 84.133, Math.toRadians(270));
//    public static Pose redGate = new Pose(15, 69.9, Math.toRadians(180));
//
//    public static Pose pickup1Pos = new Pose(11.6, 35.403,Math.toRadians(180));
//    public static Pose pickup2Pos = new Pose(11.6, 60.282, Math.toRadians(180));
...
//    public static Pose shooting2Pos = new Pose(60.265, 100.044, Math.toRadians(225));
//
//    public static Pose gatePickup1 = new Pose(16.9,68,Math.toRadians(180));
//    public static Pose gatePickup2 = new Pose(13.5,57.6,Math.toRadians(130));
