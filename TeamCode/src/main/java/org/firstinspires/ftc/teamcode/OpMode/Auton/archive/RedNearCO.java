...
//
//
//@Autonomous(name = "RED Near (15 Co)", group = "02")
//public class RedNearCO extends OpMode {
//
...
//    public static Pose initPos = new Pose(112.79, 135.293, Math.toRadians(270));
//    public static Pose shootingPos = new Pose(92.8, 84, Math.toRadians(270));
...
//    public static Pose pickup3Pos = new Pose(126.6, 82.04, Math.toRadians(0));
//    public static Pose endPos1 = new Pose(120, 84, Math.toRadians(180));
//
//    public static Pose randomPos1 = new Pose(132.862, 21.669, Math.toRadians(280));
...
//
//    public static Pose gatePickup1 = new Pose(128, 64, Math.toRadians(0));
//    public static Pose gatePickup2 = new Pose(134.5, 47.9, Math.toRadians(40));
...
//                .addPath(new BezierCurve(
//                        gatePickup1,
//                        new Pose(122.232, 62.086),
//                        new Pose(128.5, 48.423),
//                        gatePickup2
//                ))
