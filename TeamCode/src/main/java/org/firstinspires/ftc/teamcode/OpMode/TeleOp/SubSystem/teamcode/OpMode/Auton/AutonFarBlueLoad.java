...
//
//@Autonomous(name = "farBlueLoad")
//@Config
//public class AutonFarBlueLoad extends OpMode {
...
//    public static Pose initPos = new Pose(144-87.028, 6.807, Math.toRadians(180));
//    public static Pose initPos2 = new Pose(144-87.028, 6.807, Math.toRadians(270));
//
//    public static Pose shootingPos = new Pose(144-86.917, 17.702, Math.toRadians(180));
//    public static Pose shootingPos2 = new Pose(144-88.221, 14.718, Math.toRadians(180));
//
...
//    public static Pose endPos2 = new Pose(144-88.768, 33.945, Math.toRadians(180));
//    public static Pose loadPos1 = new Pose(144-138.431, 17.105,Math.toDegrees(180));
//    public static Pose loadPos2 = new Pose(144-134.282, 14.983,Math.toDegrees(180));
//
//
...
//        preLoadShot2.setLinearHeadingInterpolation(initPos.getHeading(), Math.toRadians(270));
//
//
//
...
//
//        double calculatedTurretPos =  -0.091 * turretRange + Constant.TURRET_RIGHT_MAX;; // maybe add limelight
