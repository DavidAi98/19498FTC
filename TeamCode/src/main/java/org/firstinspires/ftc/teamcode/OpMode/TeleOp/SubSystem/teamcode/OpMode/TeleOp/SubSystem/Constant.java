...
public class Constant {
    ...
    public static double GOAL_CENTER_X = 155.5; //expected 127.110236
    public static double BLUE_GOAL_CENTER_Y = -118.5; //expected 129.826772
    public static double RED_GOAL_CENTER_Y = 118.5;
...
//    public static double NOMINAL_VOLTAGE = 12.67;
    ...
    // --- Pivot ---
    public static double PIVOT_UP = 0.29;
    public static double PIVOT_DOWN = 0;

    // --- Spindexer Positions ---
    // Intake
    public static double SPINDEXER_INTAKE_POS1 = 0.014;
    public static double SPINDEXER_INTAKE_POS2 = 0.1525;
    public static double SPINDEXER_INTAKE_POS3 = 0.2925;

    // Outtake
    public static double SPINDEXER_OUTTAKE_POS1 = 0.222;
    public static double SPINDEXER_OUTTAKE_POS2 = 0.359;
    public static double SPINDEXER_OUTTAKE_POS3 = 0.0825;

    public static double SPINDEXER_INIT = SPINDEXER_INTAKE_POS1;
    public static double SPINDEXER_ANTIBACKLASH = 0.003;
    // 1,2,3 -> 2,3,1

    public static final int SPINDEXER_OUTTAKE_POS1_TICK = 1365*3;
    public static final int SPINDEXER_OUTTAKE_POS2_TICK = 1365*5;
    public static final int SPINDEXER_OUTTAKE_POS3_TICK = 1365;
    public static final int SPINDEXER_INTAKE_POS1_TICK = 0;
    public static final int SPINDEXER_INTAKE_POS2_TICK = 1365*2;
    public static final int SPINDEXER_INTAKE_POS3_TICK = 1365*4;
    public static final int SPINDEX_TICK_TOLERANCE = 250;
...
//    }
    static {
        ...
        // Velocity = SPEED_MULTI * sqrt(2 * 9.81 * dist^0.25 / sin(theta)^2)
        SHOOTING_TABLE.put(12.0,  new double[]{1400, 25});//1540-1560,
        SHOOTING_TABLE.put(20.0,  new double[]{1400, 25});//1540-1560
        SHOOTING_TABLE.put(30.0,  new double[]{1400, 25});//1540-1560
        SHOOTING_TABLE.put(40.0,  new double[]{1400, 25});//1540-1560
        SHOOTING_TABLE.put(50.0,  new double[]{1400, 25});//1640-1660, change hood later
        SHOOTING_TABLE.put(60.0,  new double[]{1400, 25});//1700-1720
        SHOOTING_TABLE.put(70.0,  new double[]{1400, 25});//1780-1800
        SHOOTING_TABLE.put(80.0,  new double[]{1400, 25});//1840-1860
        SHOOTING_TABLE.put(90.0,  new double[]{1400, 25});//1920-1940
        SHOOTING_TABLE.put(100.0, new double[]{1400, 25});
        SHOOTING_TABLE.put(130.0, new double[]{1400, 25});//2280-2300
        SHOOTING_TABLE.put(140.0, new double[]{1400, 25});//2380-2400
        SHOOTING_TABLE.put(150.0, new double[]{1400, 25});//2480-2500
        SHOOTING_TABLE.put(160.0, new double[]{1400, 25});//2540-2520
        SHOOTING_TABLE.put(170.0, new double[]{1400, 25});//2540-2520
    }
