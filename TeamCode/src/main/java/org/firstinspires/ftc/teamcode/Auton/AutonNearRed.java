...
public class AutonNearRed extends OpMode {
    ...
    public static Pose initPos = new Pose(109.790, 136.641, Math.toRadians(0));
    public static Pose shootingPos = new Pose(96.000, 95.000, Math.toRadians(45));
    public static Pose pickup3Pos = new Pose(125, 84, Math.toRadians(0));
    public static Pose blueGate = new Pose(129.5, 73, Math.toRadians(0));
    public static Pose pickup1Pos = new Pose(134, 38, Math.toRadians(0));
    public static Pose pickup2Pos = new Pose(135, 62.3, Math.toRadians(0));
    public static Pose endPos1 = new Pose(97.7, 71.8, Math.toRadians(90));
    ...
    public void buildPaths() {
        ...
        firstPickup1 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        shootingPos,
                        new Pose(96.265, 28.641),   // from (47.735,28.641) -> 144-47.735 = 96.265
                        new Pose(97.061, 35.602),   // from (46.939,35.602) -> 144-46.939 = 97.061
                        pickup1Pos))
                .setLinearHeadingInterpolation(shootingPos.getHeading(), Math.toRadians(0), 0.4) // Math.toRadians(180)->0
                .build();

        firstPickup2 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        pickup1Pos,
//                        new Pose(113.370, 44.155), // commented original; if you want mirrored: 144-113.37=30.63
//                        new Pose(102.033, 46.740), // mirrored -> 41.967
                        shootingPos))
        ...
        secondPickup1 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        shootingPos,
                        new Pose(95.072, 65.834),
                        new Pose(99.249, 67.425),
                        new Pose(93.282, 58.276),
                        pickup2Pos))
//                .setTangentHeadingInterpolation()
                .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(0), 0.4) // 135->45, 180->0
                .build();

        secondPickup2 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        pickup2Pos,
                        new Pose(89.901, 58.276),
                        shootingPos))
        ...
        thirdPickup1 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        shootingPos,
                        new Pose(90.696, 82.939), // from (53.304,82.939) -> 144-53.304 = 90.696
                        pickup3Pos))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0)) // 180->0,180->0
                .build();

        thirdPickup2 = follower.pathBuilder()
                .addPath(new BezierCurve(
                        pickup3Pos,
                        new Pose(94.276, 76.575), // from (49.724,76.575) -> 144-49.724 = 94.276
                        shootingPos))
        ...
        pickup1ToGate = follower.pathBuilder()
                .addPath(new BezierCurve(pickup3Pos,
                        new Pose(108.0, 76.575), // from (36,76.575) -> 144-36 = 108
                        blueGate))
